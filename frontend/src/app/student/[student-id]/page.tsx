...
import StudentInfoCard from "@/app/components/StudentInfoCard";
import {
  Container,
  Group,
  LoadingOverlay,
...
import StudentAttendanceRecords from "@/app/components/StudentAttendanceRecords";
  ...
  return (
    <AppShell teacher={teacherWithAccessToken.teacher}>
      <Container size="xl">
        ...
        <StudentAttendanceRecords studentId={student.studentIdNo} />
      </Container>
    </AppShell>
  );
}
